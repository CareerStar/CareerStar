...
import flippableCardFront from "../../../assets/images/activities/front.png";
import flippableCardBack from "../../../assets/images/activities/back.png";
    ...
    <div className="card-container" onClick={() => setIsFlipped(!isFlipped)}>
      <div className={`card ${isFlipped ? "flipped" : ""}`}>
        ...
        <div
          ...
          style={{ backgroundImage: `url(${flippableCardFront})` }}
        >
        ...
        <div
          className="card-back"
          style={{ backgroundImage: `url(${flippableCardBack})` }}
        >
