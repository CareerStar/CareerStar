...
const CustomerLogin = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#200043' }}>
      <div style={{ width: 360, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.15)', padding: 24, borderRadius: 12, color: '#fff', boxShadow: '0 8px 30px rgba(0,0,0,0.4)', position: 'relative', zIndex: 2 }}>
