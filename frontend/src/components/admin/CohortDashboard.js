          ...
          <div className="flex items-center justify-between mb-10">
            <div className="flex-shrink-0">
              <div className="text-white">
                <div className="text-xl font-bold leading-tight">career</div>
                <div className="text-xl font-bold leading-tight">star</div>
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen text-white relative" style={{backgroundColor: '#200043', fontFamily: 'system-ui, -apple-system, sans-serif'}}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto p-6">
        ...
        <div className="text-center py-8 border-t border-white/20"><p className="text-purple-300 mb-2">Generated by CareerStar • Summer 2025 Internship Program</p><p className="text-purple-400 text-sm">Questions? Message us hello@careerstar.co</p></div>
      </div>
    </div>
  );
};
