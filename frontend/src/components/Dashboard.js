...
function Dashboard() {
    ...
    const validPages = ['Home', 'Profile', 'Activities', 'Events', 'Network', 'Support', 'Activity', 'Resumecoach', 'Modules', 'Leaderboard'];
    useEffect(() => {
    ...
    const pages = ['Home', 'Profile', 'Activities', 'Modules', 'Leaderboard', 'Resume Coach'];
